package com.sharegram.sharegram.utility;
...
public class EmailConstructor {
	...
	public MimeMessagePreparator constructNewUserEmail(ApUser user, String password) {
	...
	public MimeMessagePreparator constructResetPasswordEmail(ApUser user, String password) {
		Context context = new Context();
		context.setVariable("user", user);
		context.setVariable("password", password);
	...
	public MimeMessagePreparator constructUpdateUserProfileEmail(ApUser user) {
		Context context = new Context();
		context.setVariable("user", user);
